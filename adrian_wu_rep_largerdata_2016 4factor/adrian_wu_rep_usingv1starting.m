...
%parms_orig = [0.0072552-0.0068665,0.98-1,0.9955-1,0.9965-1,0.9999-1,-0.0004,0.07,-0.02,0.0211,-0.0018,-0.060856,-0.0025354,0.082803,-0.017733,-0.7353,-0.2308,0.9703,0.0500,-0.5000,0.1670,-12.833,0.56487,0.03,-0.0018776,0.0040866,0.0035249,-0.0025024,-0.0064531,0.0065505]';
...
% Init value for estimating with the large data set 2003-2016
% parms=[0.005490346,-0.00578145,-0.006424965,-0.013002171,-0.005836784,-0.000774284,-0.0000798,-0.003639263,-0.000118755,0.008727525,0.083668216,0.03227906,-0.000922689,-0.01230597,-0.001681314,-0.038471238,-0.017342848,0.051939003,-0.022508971,-0.731722057,-0.169687198,0.798379336,0.001174775,0.121799894,-1.140397943,-0.128109873,0.072483442,-2.680787687,1.230069588,0.060716571,-0.001565376,0.052980987,0.00568606,0.00454202,-0.001072388,-0.007770872,0.009601945];
% Estimates with the large data set 2003-2016
% parms = csvread([workdir,'/data/parms_est_2017_2_7.csv']);
% parms_tmp = csvread([workdir,'/data/parms_est_2017_2_7.csv']); parms_tmp(28)=parms(28);parms=parms_tmp;
%parms([4 23 28])=parms_orig([4 23 28]);
%parms(28)=parms_orig(28);
% Parameters from v1 of the paper
%parms_orig = [0.0077,0.999-1,0.9998-1,0.9884-1,0.9999-1,0.0031,0.0036,-0.02,0.0006,-0.0018,0.0003,-0.0072,0.06161,-0.0037,0.0049,-0.0177,-0.7353,-0.2308,0.9703,0.05,-0.5,0.167,0.0807,1.2922,0.9952,-0.0058,-0.0029,0.0048,-0.0031,-0.002,0.0144,-0.0030,-0.0028,0.0028]';
% TEST3
parms_orig = [0.0077,0.999-1,0.9998-1,0.9884-1,0.9999-1,0.0031,0.0036,-0.02,0.0006,-0.0018,0.0003,-0.0072,0.06161,-0.0037,0.0049,-0.0177,-0.7353,-0.2308,0.9703,0.05,-0.5,0.167,0.0807,1.2922,0.9952,-0.0058,-0.0029,0.0048,-0.0031,-0.002,0.0144,-0.0030,-0.0028,0.0028,0.0084,-0.0039,-0.0015]';
parms = parms_orig;
%--------------------------------------------------------------------------
...
% toc
% parms = parms_est;
% csvwrite(['./data/parms_est_',num2str(rundate(1)),'_',num2str(rundate(2)),'_',num2str(rundate(3)),'.csv'],parms_est);
%--------------------------------------------------------------------------
%--------------------------------------------------------------------------
tic
