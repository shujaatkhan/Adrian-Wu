...
%}
%--------------------------------------------------------------------------
data_run.C_0y_temp_tau_s1 = C_0y_temp_tau;
data_run.C_0r_temp_tau_s1 = C_0r_temp_tau;
data_run.C_1y_temp_mat_tau_s1 = C_1y_temp_mat_tau;
data_run.C_1r_temp_mat_tau_s1 = C_1r_temp_mat_tau;
data_run.D_0y_temp_tau_s1 = D_0y_temp_tau;
data_run.D_1y_temp_tau_s1 = D_1y_temp_tau;
data_run.D_0r_temp_tau_s1 = D_0r_temp_tau;
data_run.D_1r_temp_tau_s1 = D_1r_temp_tau;
data_run.D_0yr_temp_tau_s1 = D_0yr_temp_tau;
data_run.D_1yr_temp_tau_s1 = D_1yr_temp_tau;
save('s1data.mat', '-struct', 'data_run');
