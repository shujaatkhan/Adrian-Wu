...
T = size(data,1);
ny = size(data,2);
mu = zeros(nx,1); mu(1:4)= parms(1:4);

Phi = diag([parms(5),parms(6),parms(7),parms(8),parms(9)]);
Phi(2:end,1) = parms(10:13);
Phi(3:end,2) = parms(14:16);
Phi(4:end,3) = parms(17:18);
Phi(5,4) = parms(19);
Phi = Phi + eye(5);

S_0tilde = diag([parms(20) parms(21) parms(22) parms(23) parms(24)]);
S_0mat = S_0tilde*S_0tilde';
S_0 = S_0mat(:);

S_1tilde = diag([parms(25) parms(26) parms(27) parms(28)]);
S_1tilde(1,2:4) = parms(29:31);
S_1tilde(2,3:4) = parms(32:33);
S_1tilde(3,4) = parms(34);
...
del_1 = zeros(nx,1); del_1(1:4)=parms(35:38);

lambda_0 = zeros(nx,1); lambda_0(end) = parms(39);

lambda_1 = diag([parms(40) parms(41) parms(42)  parms(43) parms(44)]);
lambda_1(1,2:end) = parms(45:48);
lambda_1(2,3:5) = parms(49:51);
lambda_1(3,4:5) = parms(52:53);
lambda_1(4,5) = parms(54);keyboard
%--------------------------------------------------------------------------
